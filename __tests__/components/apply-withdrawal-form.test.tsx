...
describe("ApplyWithdrawalForm", () => {
    ...
    it("shows error when amount is below minAmount", () => {
        render(<ApplyWithdrawalForm {...defaultProps} />)
        const input = screen.getByLabelText(/提现金额/i)
    ...
    it("shows error when amount exceeds withdrawable balance", () => {
        render(<ApplyWithdrawalForm {...defaultProps} />)
        const input = screen.getByLabelText(/提现金额/i)
    ...
    it("uses default minAmount of 50 when prop is not provided", () => {
