...
export async function GET() {
    ...
    const [settledSum, paidSum, pendingSum, weekOrders, tiers] = await Promise.all([
    ...
    let currentTier: { minAmount: number; maxAmount: number; ratePercent: number; sortOrder: number } | null = null
    ...
    let nextTier: { minAmount: number; maxAmount: number; ratePercent: number; sortOrder: number } | null = null
    if (currentTier) {
