      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
            ...
            <PageHeader title="新建模板" description="使用可视化编辑器设计邮件模板" />
          </div>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="例：双十一促销" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="例：双十一大促，限时优惠！" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
        ...
        <UnlayerEditor editorRef={editorRef} initialDesign={initialDesign} />
      </form>
    </Form>
  )
}
