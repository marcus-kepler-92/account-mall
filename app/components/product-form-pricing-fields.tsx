...
/**
 * Renders the 价格与限制 Card.
 *
 * For MANUAL products, the price/cost/stock fields are intentionally omitted
 * — those values live on each SKU row in the SKU 管理 Card rendered directly
 * below by ProductForm. Keeping just the productType radio + an inline notice
 * makes the section feel intentional rather than "stripped down".
 *
 * 商品简介 and 商品描述 Cards moved to ProductFormContentCards so the SKU
 * panel can sit adjacent to the pricing Card.
 */
